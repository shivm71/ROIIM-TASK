...
class App extends React.Component {
       ...
       async onPayment(){
            ...
            //ajax call
            fetch('https://shiaam71.pythonanywhere.com/pay/', requestOptions)
                            ...
                            <Col>
                              <Form>
                                  ...
                                  <Form.Group controlId="First Name">
                                    ...
                                    <Form.Control placeholder="First Name" value={firstName} onChange={(e)=>{this.onChangeFirstName(e.target.value)}} required />
                                  </Form.Group>
